...
namespace CustomSwaggerGen
{
    public class XmlCommentsParameterFilter : IParameterFilter
    {
        ...
        private void ApplyParamTags(OpenApiParameter parameter, ParameterFilterContext context)
        {
            ...
            var paramNode = _xmlNavigator.SelectSingleNodeRecursive(methodMemberName, $"param[@name='{context.ParameterInfo.Name}']")?.SelectSingleNode($"param[@name='{context.ParameterInfo.Name}']");

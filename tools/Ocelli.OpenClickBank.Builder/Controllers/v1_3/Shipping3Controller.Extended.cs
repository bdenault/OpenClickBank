...
/// <inheritdoc cref="Shipping3ControllerBase" />
[ApiController]
...
public class Shipping3Controller : Shipping3ControllerBase
{
    ...
    [HttpGet, Route("1.3/shipping3/count")]
    [Authorize]
    ...
    [HttpGet, Route("1.3/shipping3/list")]
    [Authorize]
    ...
    /// <inheritdoc cref="Shipping3ControllerBase.GetShipNotice" />
    [Authorize]
    [Produces("application/json", "application/xml")]
    [ApiAuthorizationFilter(new[] { ApiPermission.API_ORDER_READ, ApiPermission.HAS_DEVELOPER_KEY })]
